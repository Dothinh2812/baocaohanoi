...
function renderKiemSoatMain(data) {
    ...
    renderKiemSoatTable(_kiemsoatActiveTeam, data.sheets[_kiemsoatActiveTeam], container, data.file_info);
}

function renderKiemSoatTable(team, sheetData, container, fileInfo) {
    if (!container) return;
