# -*- coding: utf-8 -*-
"""
Module xử lý giảm trừ phiếu báo hỏng theo phương pháp HNI (Hà Nội)
...
Công thức:
  Tỷ lệ % (Sau GT) = (Phiếu đạt gốc + Phiếu GT không đạt) / Tổng phiếu thô × 100

Ví dụ:
  - Trước GT: 90 đạt / 100 tổng = 90%
  - Giảm trừ 5 phiếu (không đạt → đạt)
  - Sau GT: (90 + 5) / 100 = 95%  (mẫu số giữ nguyên)
...
- Xuất kết quả vào thư mục downloads/kq_sau_giam_tru_hni/
"""
