...
TRAINING_DB_PATH = os.path.abspath(
    _env_value(
        'DASHV4_TRAINING_DB_PATH',
        default=os.path.join(INSTANCE_RUNTIME_DIR, 'training.db'),
    )
)
TRAINING_FILES_DIR = os.path.abspath(
    _env_value(
        'DASHV4_TRAINING_FILES_DIR',
        default=os.path.join(INSTANCE_RUNTIME_DIR, 'training_files'),
    )
)
TRAINING_EXPORT_DIR = os.path.abspath(
    _env_value(
        'DASHV4_TRAINING_EXPORT_DIR',
        default=os.path.join(INSTANCE_RUNTIME_DIR, 'training_export'),
    )
)
TRAINING_AI_ENABLED = _env_flag('DASHV4_TRAINING_AI_ENABLED', default=False)
TRAINING_AI_PROVIDER = _env_value('DASHV4_TRAINING_AI_PROVIDER', default='fake')
TRAINING_AI_MODEL = _env_value('DASHV4_TRAINING_AI_MODEL', default='')
TRAINING_MAX_TEXT_BYTES = int(_env_value('DASHV4_TRAINING_MAX_TEXT_BYTES', default='200000'))
TRAINING_GENERATION_TIMEOUT_SECONDS = int(
    _env_value('DASHV4_TRAINING_GENERATION_TIMEOUT_SECONDS', default='120')
)
TRAINING_LEASE_SECONDS = int(_env_value('DASHV4_TRAINING_LEASE_SECONDS', default='300'))
TRAINING_MAX_RETRIES = int(_env_value('DASHV4_TRAINING_MAX_RETRIES', default='3'))
...
class DashboardConfig:
    ...
    TRAINING_FILES_DIR = TRAINING_FILES_DIR
    TRAINING_EXPORT_DIR = TRAINING_EXPORT_DIR
    TRAINING_AI_ENABLED = TRAINING_AI_ENABLED
    TRAINING_AI_PROVIDER = TRAINING_AI_PROVIDER
    TRAINING_AI_MODEL = TRAINING_AI_MODEL
    TRAINING_MAX_TEXT_BYTES = TRAINING_MAX_TEXT_BYTES
    TRAINING_GENERATION_TIMEOUT_SECONDS = TRAINING_GENERATION_TIMEOUT_SECONDS
    TRAINING_LEASE_SECONDS = TRAINING_LEASE_SECONDS
