...
### Thông tin đăng nhập
- ✅ `BAOCAO_USERNAME` (từ: `"your_username"`)
- ✅ `BAOCAO_PASSWORD` (từ: `"your_password"`)
...
```python
class Config:
    BAOCAO_USERNAME = os.getenv('BAOCAO_USERNAME', 'your_username')  # Default value
    BAOCAO_PASSWORD = os.getenv('BAOCAO_PASSWORD', 'your_password')     # Default value
```
...
class Config:
    BAOCAO_USERNAME = "your_username"  # Hardcode
    BAOCAO_PASSWORD = "your_password"     # Hardcode
    # ...
```
